...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.body.mood) {
        ...
        response = yield db.registerPatient(username, password, email, req.body.mood);
    }
    else {
        /* If no mood is sent then this is a counselor */
        response = yield db.registerCounselor(username, password, email, req.body.university, req.body.graduated);
    }
    if (response.message) {
        res.json({
            ok: false,
...
const updateDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.body.username) {
        ...
        try {
            ...
            return res.json({
                ok: false,
                message: "An error has occurred while changing your username, probably the new username is already taken",
            });
        }
        /* Update JWT payload */
    ...
    if (req.body.email) {
        ...
        try {
            ...
            return res.json({
                ok: false,
                message: "An error has occurred while changing your email, probably the new email is already taken",
            });
        }
        /* Update JWT payload */
