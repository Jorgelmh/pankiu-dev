 ...
 */
const getChats = (id) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
 ...
 */
const changeMood = (id, mood) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
    const [rows,] = yield conn.execute(`UPDATE patients SET mood=? WHERE user_id=?`, [
        mood,
        id,
    ]);
    conn.end();
 ...
 *
 */
const addFriend = (id, uid) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
 ...
 */
const getFriendRequests = (id) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
    const rows = (yield conn.execute(`SELECT friends.sender_id, users.username FROM 
  friends, users WHERE friends.receiver_id=? AND friends.accepted=? AND users.id=friends.sender_id ORDER BY friends.date`, [id, 0]))[0];
    const requests = [];
 ...
 */
const acceptFriendRequest = (id, oid) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
 ...
 *  ==============================================
 */
const registerUser = (email, username, password, conn) => __awaiter(void 0, void 0, void 0, function* () {
    /* Check if the username has already been taken */
    const rows = ((yield conn.execute(`SELECT * FROM users WHERE username=?`, [username]))[0]);
    if (rows.length)
        return "Username already taken";
    /* Check if the email has already been taken */
    const rows1 = ((yield conn.execute(`SELECT * FROM users WHERE email=?`, [email]))[0]);
    if (rows1.length)
    ...
    try {
        ...
        yield conn.execute(`INSERT INTO users (username, email, password, isadmin) values (?,?,?,?)`, [username, email, hash, 0]);
    }
    catch (e) {
        console.log(e);
        conn.end();
 ...
 */
const registerPatient = (username, password, email, mood) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
 ...
 */
const registerCounselor = (username, password, email, university, graduated) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
    /* Check username and email */
    const error = yield registerUser(email, username, password, conn);
...
const authenticateUser = (username, password) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
    const rows = ((yield conn.execute(`SELECT id, password, email, isadmin FROM users WHERE username=?`, [username]))[0]);
    ...
    if (rows.length) {
        ...
        if (passwordOK) {
            ...
            const patient = ((yield conn.execute(`SELECT mood FROM patients WHERE user_id=?`, [
                rows[0].id,
            ]))[0]);
            if (patient.length) {
                conn.end();
            ...
            const counselor = ((yield conn.execute(`SELECT rate FROM counselors WHERE user_id=?`, [
                rows[0].id,
            ]))[0]);
            if (counselor.length) {
                conn.end();
 ...
 */
const updateUsername = (id, username) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
    /* Try to change the name */
    yield conn.execute(`UPDATE users SET username=? WHERE id=?`, [username, id]);
    conn.end();
});
 ...
 */
const updateEmail = (id, email) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
 ...
 */
const recordMessage = (sender_id, receiver_id, message) => __awaiter(void 0, void 0, void 0, function* () {
    /* Get a connection */
    const conn = yield exports.getConnection();
    /* Record the message in the db */
    yield conn.execute(`INSERT INTO messages (time, message, receiver_id, sender_id) VALUES (?, ?, ?, ?)`, [
        new Date().toISOString().slice(0, 19).replace("T", " "),
        message,
        receiver_id,
        sender_id,
